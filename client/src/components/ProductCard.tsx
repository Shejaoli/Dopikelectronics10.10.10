  ...
  return (
    ...
    >
      ...
      <Link href={`/product/${product.id}`}>
        <div className="relative aspect-square cursor-pointer overflow-hidden bg-accent/5 p-4">
          <img 
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/5 opacity-0 backdrop-blur-[2px] transition-opacity duration-300 group-hover:opacity-100">
             <span className="rounded-full bg-white/90 backdrop-blur-md px-4 py-1.5 text-xs font-semibold text-black shadow-xl ring-1 ring-black/5">Quick View</span>
          </div>
        </div>
      </Link>
      ...
      <div className="flex flex-1 flex-col p-4">
        <div className="mb-0.5 text-[9px] font-bold uppercase tracking-[0.1em] text-primary/80">
          {product.brand}
        </div>
        <Link href={`/product/${product.id}`}>
          <h3 className="mb-1.5 line-clamp-2 cursor-pointer text-base font-bold leading-tight text-foreground transition-colors hover:text-primary">
            {product.name}
          </h3>
        </Link>
        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          <a 
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-primary transition-all hover:bg-primary hover:text-primary-foreground hover:scale-110 active:scale-95"
