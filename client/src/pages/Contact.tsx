        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/10 bg-card p-6 sm:col-span-2">
                <div className="mb-4 inline-flex rounded-full bg-primary/10 p-3 text-primary">
                  <MapPin className="h-6 w-6" />
                </div>
                <h3 className="mb-2 text-lg font-bold text-white">Visit Our Store</h3>
              ...
              <div className="rounded-2xl border border-white/10 bg-card p-6 sm:col-span-2">
                ...
                <h3 className="mb-2 text-lg font-bold text-white">Opening Hours</h3>
            ...
            <div className="rounded-3xl border border-white/10 bg-card p-2 overflow-hidden h-[400px] lg:h-auto">
               <iframe 
